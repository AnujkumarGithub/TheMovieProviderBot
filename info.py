...
BOT_TOKEN = environ.get('BOT_TOKEN', "7283031443:AAFmkp2nNTk_dfxEDgrTqt3TnEVy7eRILfc")
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002328701263')) #Log channel id ( make sure bot is admin )
